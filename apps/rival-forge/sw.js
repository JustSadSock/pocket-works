const CACHE='rival-forge-v1.3.0';
const APP_SHELL=['./','./index.html','./styles.css','./upgrade.css','./match.css','./app.js','./store.js','./builder.js','./profiles.js','./match.js','./match-core.js','./state-codec.js','./catalog.js','./sheets.js','./data.js','./loadouts.js','./core.js','./manifest.webmanifest','./icons/icon.svg','../../shared/mobile-runtime.js','../../shared/update-manager.js'];
