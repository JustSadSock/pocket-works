const CACHE_PREFIX = 'poryadok-';
const CACHE_NAME = 'poryadok-v1.0.0-p1';
const APP_VERSION = '1.0.0';
const RELEASE_DATE = '2026-07-25';
const CACHE_PROTOCOL = 1;
const RELEASE_NOTES = [
  'Непрерывная шкала от протона до наблюдаемой Вселенной.',
  'Сравнение закреплённых объектов и отношений размеров.',
  'Кубы восьми материалов одинаковой массы.'
];
const APP_SHELL = [
  './',
  './index.html',
