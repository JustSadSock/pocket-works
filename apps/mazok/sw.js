...
const CACHE_NAME = 'mazok-v2.1.0';
const APP_VERSION = '2.1.0';
const RELEASE_DATE = '2026-08-07';
const CACHE_PROTOCOL = 4;
const RELEASE_NOTES = [
  'Добавлен отдельный инструмент «Восковой мелок» с зернистой восковой фактурой, бороздками и крошками по краям.',
  'Текстура мелка сохраняется одинаковой после перезапуска, в PNG, миниатюрах и таймлапсе.'
];
const APP_SHELL = [
  './',
  './index.html',
