...
const CACHE_NAME = 'mazok-v0.1.0';
const APP_VERSION = '0.1.0';
const RELEASE_DATE = '2026-07-23';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = ["Первый выпуск: полноэкранный холст, четыре инструмента, жесты масштаба, история действий, автосохранение, галерея и экспорт PNG."];
const APP_SHELL = [
  './',
  './index.html',
  './app.config.json',
