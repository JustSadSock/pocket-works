const CACHE='forma-v1.0.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./icons/icon.svg','./FORMA-AI-GUIDE.md','./src/engine.js','./src/mesher.js','./src/renderer.js','./src/exporters.js','./src/spec.js','./src/worker.js'];
