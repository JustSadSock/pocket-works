...
import { terrainHeight, terrainNormal, terrainSlope } from './terrain.js';
...
console.log('SIROCCO core tests: deterministic terrain, seamless boundaries and normals OK');
