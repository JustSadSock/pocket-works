...
const CACHE_NAME = 'chancellery-v0.1.0';
const APP_VERSION = '0.1.0';
const RELEASE_DATE = '2026-07-30';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Added local import for plaintext and ZIP-compressed Europa Universalis V saves.',
  'Added a streaming Clausewitz parser and persistent campaign passports.',
  'Added format diagnostics and offline support.'
];
