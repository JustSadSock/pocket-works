...
const releaseNotes = [
  ...
  'Физические паруса получили стабильную UV-развёртку и отдельную двухстороннюю световую модель без самозатенения, устраняющую чёрную ткань на Safari/WebKit.',
