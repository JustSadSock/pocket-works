...
const releaseNotes = [
  'Вёсла снова читаются физически: при удержании ГРЕСТИ весь выбранный комплект выходит из бортов, вращается вокруг реальных уключин, проходит медленный силовой гребок, поднимается на возврате и даёт брызги у лопасти.',
  ...
  'Взаимодействие корпуса с водой теперь зависит от скорости: встречная скорость волны создаёт дополнительное волновое сопротивление, динамическую осадку, удар носом и отпускание после гребня; носовой спрей, бортовая пена и кильватер растут нелинейно с ходом.',
