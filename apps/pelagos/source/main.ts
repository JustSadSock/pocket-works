...
const releaseNotes = [
  ...
  'Отделки верфи теперь меняют не только цвет: лак, просмолённое дерево, палуба и ткань получают собственную физическую шероховатость и характер блика.',
