...
const releaseNotes = [
  ...
  'Взаимодействие корпуса с водой теперь зависит от скорости: встречная скорость волны создаёт дополнительное волновое сопротивление, динамическую осадку, удар носом и отпускание после гребня; носовой спрей и кильватер растут нелинейно с ходом.',
