...
const RELEASE_NOTES = [
  ...
  'Число Фруда связывает скорость с длиной корпуса: волновое сопротивление, динамическая осадка, носовая волна, удар об гребень и кильватер меняются и со скоростью, и с выбранным корпусом.',
