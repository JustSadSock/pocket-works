...
const RELEASE_NOTES = [
  ...
  'Контактная пена и кильватер масштабируются вместе с корпусом и начинаются у его фактического транца.',
  'Двухстороннее освещение парусной ткани устраняет чёрные паруса на Safari/WebKit.'
];
