const CACHE_PREFIX = 'fifty-hz-';
const CACHE_NAME = 'fifty-hz-v1.0.0-p1';
const APP_VERSION = '1.0.0';
const RELEASE_DATE = '2026-07-15';
const CACHE_PROTOCOL = 1;
const RELEASE_NOTES = [
  'Добавлена законченная трёхминутная смена с динамическим спросом, аварийными событиями, рейтингом и локальным рекордом.',
  'Реализованы физические рубильники районов, перетаскиваемый регулятор генератора, аварийный аккумулятор и аналоговая частотная шкала.',
  'Приложение сохраняет активную смену и настройки, работает офлайн, поддерживает звук, вибрацию, reduced motion и Workshop Mode.'
];
const APP_SHELL = [
  './', './index.html', './app.config.json', './styles.css', './app.js', './game-core.js', './manifest.webmanifest', './icons/icon.svg',
  '../../shared/mobile-runtime.css', '../../shared/mobile-runtime.js', '../../shared/pwa-utils.js', '../../shared/update-manager.css', '../../shared/update-manager.js', '../../shared/workshop-mode.css', '../../shared/workshop-mode.js',
  '../../shared/capabilities/motion.js', '../../shared/capabilities/storage.js', '../../shared/capabilities/transfer.js', '../../shared/capabilities/audio.js', '../../shared/capabilities/device.js', '../../shared/capabilities/diagnostics.js'
];
