...
export const STAGES: StageDefinition[] = [
  { id:1, code:'CH 01', name:'LOCAL WEATHER', strap:'Tonight: impossible conditions.', bossKind:'weather', palette:p(0xeadfc6,0x1a2220,0xe95d3f,0x5b817d,0xe7bb49,0xff64c8,0x96b8ad), runLength:11500, encounterCount:5, baseBossHp:1900, enemyDensity:0.82, gravity:1180, moveSpeed:285, bossScale:1.0, unlockAfter:0 },
  { id:2, code:'CH 02', name:'DINNER AT ELEVEN', strap:'A recipe with no exit.', bossKind:'chef', palette:p(0xf1d2a5,0x2a211e,0xc8422d,0x7b8e55,0xe8902e,0xff6bc9,0x8a6f56), runLength:12400, encounterCount:5, baseBossHp:2150, enemyDensity:0.90, gravity:1200, moveSpeed:288, bossScale:1.0, unlockAfter:1 },
  { id:3, code:'CH 03', name:'SUNDAY FINAL', strap:'The crowd wants overtime.', bossKind:'sport', palette:p(0xe8e1c9,0x151a1d,0x2f6cb1,0xd25e39,0xf1c84a,0xff63cb,0x7ea29d), runLength:13300, encounterCount:6, baseBossHp:2400, enemyDensity:0.96, gravity:1220, moveSpeed:292, bossScale:1.02, unlockAfter:2 },
