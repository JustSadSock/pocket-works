...
const RELEASE_NOTES = [
  'Исправлена формула замкнутого сплайна: дорожные сегменты теперь непрерывно сходятся и не образуют разрывов или случайных изломов.',
  'Свободная генерация заменена устойчивым семейством процедурных контуров с проверкой самопересечений, минимального расстояния и локальной кривизны.',
  'Управление стало быстрее и предсказуемее: уменьшена задержка руля, убрана постоянная боковая плавучесть и добавлена мягкая стабилизация после заноса.',
  'Тормозной дрифт сохранён, но теперь начинается контролируемо и не раскачивает машину после отпускания кнопок.'
];
const APP_SHELL = [
  './',
  './index.html',
