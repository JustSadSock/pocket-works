...
const CACHE_NAME='shpilka-v2.9.0-p1';
const APP_VERSION='2.9.0';
const RELEASE_DATE='2026-07-16';
const CACHE_PROTOCOL=1;
const RELEASE_NOTES=[
'Трассы получили пять характерных секций для каждого архетипа и более выразительную геометрию.',
'Добавлены вода, скалы, лес, портовые объекты, ограждения, тормозные щиты и живая мини-карта.',
'Добавлен косметический гараж: цвет, ливрея и номер без изменения характеристик машины.'
];
const APP_SHELL=[
'./','./index.html','./app.config.json','./styles.css','./advanced.css','./advanced-fixes.css','./systems-23.css','./systems-25.css','./systems-26.css','./systems-27.css','./systems-28.css','./systems-282.css','./systems-29.css','./app.js',
...Array.from({length:11},(_,i)=>`./engine-v2-${String(i+1).padStart(2,'0')}.js`),
'./engine-v2-stability.js','./engine-v2-advanced.js','./engine-v2-advanced-fixes.js','./engine-v2-23-ui.js','./engine-v2-23.js','./engine-v2-23-fixes.js','./engine-v2-24.js','./engine-v2-25-ai.js','./engine-v2-25-race.js','./engine-v2-25-1.js','./engine-v2-25-contacts.js','./engine-v2-25-wall.js','./engine-v2-26-career.js','./engine-v2-26-racecraft.js','./engine-v2-26-landmarks.js','./engine-v2-26-feel.js','./engine-v2-26-fixes.js','./engine-v2-27-ai.js','./engine-v2-27-fixes.js','./engine-v2-27-1.js','./engine-v2-27-2.js','./engine-v2-28-route.js','./engine-v2-28-ai.js','./engine-v2-28-physics.js','./engine-v2-28-fixes.js','./engine-v2-28-ui.js','./engine-v2-28-1.js','./engine-v2-28-2.js','./engine-v2-29-route.js','./engine-v2-29-scenery.js','./engine-v2-29-navigation.js','./engine-v2-29-ui.js','./engine-v2-12.js','./workshop.js','./manifest.webmanifest','./icons/icon.svg','../../shared/mobile-runtime.css','../../shared/mobile-runtime.js','../../shared/pwa-utils.js','../../shared/update-manager.css','../../shared/update-manager.js','../../shared/workshop-mode.css','../../shared/workshop-mode.js','../../shared/capabilities/motion.js','../../shared/capabilities/storage.js','../../shared/capabilities/transfer.js','../../shared/capabilities/audio.js','../../shared/capabilities/device.js','../../shared/capabilities/diagnostics.js'];
