...
const CACHE_NAME = 'shpilka-v2.7.1-p1';
const APP_VERSION = '2.7.1';
const RELEASE_DATE = '2026-07-14';
const CACHE_PROTOCOL = 1;
const RELEASE_NOTES = [
  'Гоночная линия AI сглаживается по нескольким точкам впереди и больше не дёргается вслед за каждой локальной поправкой.',
  'Рулевой сигнал ограничен по скорости изменения и сначала возвращается к центру перед сменой направления.',
  'Обгон и защита удерживают выбранную полосу, а боковое уклонение включается только при непосредственной угрозе контакта.',
  'Убрана постоянная змейка, из-за которой соперники теряли скорость и мешали друг другу.'
];
const APP_SHELL = [
  './',
  './index.html',
