...
export default defineConfig({
  ...
  plugins: [
    VitePWA({
      ...
      manifest: {
        id: '/apps/colossus-inside/',
        name: 'COLOSSUS // INSIDE',
        short_name: 'COLOSSUS',
        description: 'Climb a living biomechanical colossus through a storm and repair its failing stabilizer.',
        start_url: './',
        scope: './',
        display: 'standalone',
      ...
      injectManifest: {
        ...
        maximumFileSizeToCacheInBytes: 36 * 1024 * 1024
      },
