...
const RELEASE_NOTES = [
  'Процедурный voxel-мир с водой, деревьями, пещерами и пиксельными материалами.',
  'Горизонтальное сенсорное управление с обзором, прыжком, разрушением и установкой блоков.',
  'Творческий инвентарь, хотбар, локальное автосохранение мира и настроек.',
  'WebGL2-рендерер без внешних библиотек и сетевых зависимостей.'
];
const APP_SHELL = [
  './',
  './index.html',
