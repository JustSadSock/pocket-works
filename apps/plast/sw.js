...
const RELEASE_NOTES = [
  'Процедурный voxel-мир с холмами, берегами, водой, деревьями и пещерами.',
  'Мобильное управление для горизонтального экрана: плавающий стик, обзор пальцем, прыжок, разрушение и установка блоков.',
  'Творческий инвентарь, семь слотов быстрого доступа, десять строительных материалов и выделение выбранной грани.',
  'Сохранение мира, позиции, настроек и всех изменений блоков локально на устройстве.',
  'WebGL2-рендер с пиксельными материалами, туманом, прозрачной водой, циклом освещения и анимациями руки.'
];
const APP_SHELL = [
  './',
  './index.html',
