...
const CACHE_NAME = 'rat-v2.1.1';
const APP_VERSION = '2.1.1';
const RELEASE_NOTES = [
  'Предбоевые приказы теперь выдаются прямо на настоящем поле боя, а не на отдельном схематичном экране.',
  'До сигнала симуляция полностью остановлена: карта, рельеф и все десять полков уже видны, но таймер остаётся на 00:00.',
  'Каждый из пяти своих полков получает один бесплатный стартовый приказ существующим жестом: держать, атаковать, обойти или отступить.',
  'Бой можно начать только после пяти приказов; оставшимся полкам можно одним нажатием назначить удержание позиции.'
];
const APP_SHELL = [
  './',
  './index.html',
