const CACHE_PREFIX = 'blazon-';
const CACHE_NAME = 'blazon-v1.0.0';
const APP_VERSION = '1.0.0';
const RELEASE_DATE = '2026-07-17';
const CACHE_PROTOCOL = 1;
const RELEASE_NOTES = [
  'Три игровых дома и поход против трёх соперников.',
  'Закон тинктур, ересь, симметрия, ординарии и позиционные бонусы напрямую решают бой.',
  'Пожалования после побед, тактический бот, сохранение, звук, тактильная отдача и офлайн-режим.'
];
const APP_SHELL = [
  './',
  './index.html',
