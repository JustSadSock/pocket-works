...
if (!document.querySelector('link[href="./field-journal.css"]')) {
  const fieldJournalStyle = document.createElement('link');
  fieldJournalStyle.rel = 'stylesheet';
  fieldJournalStyle.href = './field-journal.css';
  document.head.append(fieldJournalStyle);
}
