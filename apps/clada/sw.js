...
const CACHE_NAME = 'clada-v5.1.0';
const APP_VERSION = '5.1.0';
const RELEASE_DATE = '2026-07-30';
const CACHE_PROTOCOL = 13;
const RELEASE_NOTES = [
  'Мир получил 64 детерминированные экологические ячейки с Delaunay/Voronoi-подобной геометрией и устойчивой сетью соседства.',
  'Виды теперь перестраивают среду: создают тропы, почвы, болота, каналы, рифы, открытые луга, органические осадки и пожарные мозаики.',
  'Добавлен режим «След жизни» с интерактивной картой, причинными цепочками и паспортами ячеек и видов-инженеров.',
  'Инженерные следы влияют на ресурсы, влажность и связность расселения, но остаются ограниченными и не накапливают технический дрейф.'
];
const APP_SHELL = [
  './', './index.html', './app.config.json', './styles.css', './living.css', './field-journal.css', './living-planet.css', './observable-life.css', './genetics.css', './life-trace.css', './app.js', './manifest.webmanifest', './icons/icon.svg', './workshop.js',
  ...
  './runtime/v5/24-01.txt', './runtime/v5/24-02.txt', './runtime/v5/24-03.txt', './runtime/v5/24-04.txt', './runtime/v5/24-05.txt', './runtime/v5/25-01.txt', './runtime/v5/25-02.txt', './runtime/v5/26-01.txt', './runtime/v5/26-02.txt', './runtime/v5/26-03.txt', './runtime/v5/26-04.txt', './runtime/v5/27-01.txt', './runtime/v5/27-02.txt',
