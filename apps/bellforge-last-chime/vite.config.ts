...
export default defineConfig({
  ...
  plugins: [
    VitePWA({
      ...
      manifest: {
        id: '/apps/bellforge-last-chime/',
        name: 'BELLFORGE // THE LAST CHIME',
        short_name: 'BELLFORGE',
        description: 'Cross a hand-built clockwork city, restore its resonators and decide whether the Great Bell should ring again.',
        start_url: './',
        scope: './',
        display: 'standalone',
        display_override: ['fullscreen', 'standalone', 'minimal-ui'],
        orientation: 'landscape',
        background_color: '#17222a',
        theme_color: '#17222a',
