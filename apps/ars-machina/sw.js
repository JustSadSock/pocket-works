...
const CACHE_NAME = 'ars-machina-v1.5.0-p4';
const APP_VERSION = '1.5.0';
const RELEASE_DATE = '2026-07-19';
const CACHE_PROTOCOL = 4;
const RELEASE_NOTES = [
  'Узел, шарнир и скоба объединены в один инструмент «Крепление» с режимами «Свободное» и «Жёсткое».',
  'Жёсткое крепление фиксирует угол балок и блокирует вращение установленного на валу механизма относительно рамы.',
  'Тип крепления меняется в инспекторе у узла, соединения или вращающейся детали без перестройки конструкции.',
  'Шестерни, колёса, лебёдки, блоки, маховики и передачи получили более читаемый механический визуал и анимацию движения.'
];
const APP_SHELL = [
  './',
  './index.html',
