...
const CACHE_NAME = 'ars-machina-v2.1.0-p7';
const APP_VERSION = '2.1.0';
const RELEASE_DATE = '2026-07-20';
const CACHE_PROTOCOL = 7;
const RELEASE_NOTES = [
  'Механическое зрение показывает путь момента, передаточные числа, активные контуры A/B, силы воздуха и воды, траектории и места ударов.',
  'Валы синхронизируются с учётом инерции, заводная пружина передаёт конечный момент всему валу, а барабан действительно работает по дискретным позициям.',
  'Исправлены направление подъёмной силы, плавучесть, автоматический запуск метателей по контуру, влияние лука на выстрел и поглощение энергии бронёй.',
  'Добавлены проверка взаимодействий, предупреждения прямо на деталях, учебный лист «Путь силы» и исправленный гигантский арбалет.'
];
const APP_SHELL = [
  './',
  './index.html',
