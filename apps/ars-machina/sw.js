...
const CACHE_NAME = 'ars-machina-v2.0.0-p6';
const APP_VERSION = '2.0.0';
const RELEASE_DATE = '2026-07-20';
const CACHE_PROTOCOL = 6;
const RELEASE_NOTES = [
  'ARS MACHINA оформлена как Codice delle Macchine: пергамент, коричневые чернила, красный мел, зеркальные заметки и рисованные листы машин.',
  'Добавлены воздух, вода, подъёмная сила, парашютное сопротивление, плавучесть, броня и отражение снарядов.',
  'Добавлены заводные пружины, кулачки, программные барабаны, механические секвенсоры, приводы шарниров, воздушные мешки и многозарядные метатели.',
  'В Кодексе доступны десять рабочих машин Леонардо, собранных из тех же редактируемых деталей, что и пользовательские модели.'
];
const APP_SHELL = [
  './',
  './index.html',
