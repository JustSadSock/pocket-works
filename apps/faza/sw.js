...
const CACHE_NAME = 'faza-v1.2.0';
const APP_VERSION = '1.2.0';
const RELEASE_DATE = '2026-07-18';
const CACHE_PROTOCOL = 5;
const RELEASE_NOTES = [
  'Главное меню теперь показывает реальную механику на мини-поле.',
  'Ход читается как последовательность «клетка → разрез → подтверждение».',
  'Поле стало чище: второстепенные разрывы скрыты, а важные состояния получили разные обозначения.',
  'Переработаны портретная, альбомная и широкая компоновки интерфейса.'
];
const APP_SHELL = [
  './',
  './index.html',
