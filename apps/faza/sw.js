...
const CACHE_NAME = 'faza-v1.1.0';
const APP_VERSION = '1.1.0';
const RELEASE_DATE = '2026-07-18';
const CACHE_PROTOCOL = 3;
const RELEASE_NOTES = [
  'Фазы переименованы в наглядные разрезы «Без ↔», «Без ↗» и «Без ↘».',
  'Перед подтверждением хода поле показывает действующие связи, разрезанные пары, дыхание и будущие захваты.',
  'Ход бота теперь воспроизводится по этапам с объяснением выбранной клетки и выключенной оси.',
  'Правила и анимации переработаны для более медленного и понятного чтения позиции.'
];
const APP_SHELL = [
  './',
  './index.html',
