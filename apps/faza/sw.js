...
const CACHE_NAME = 'faza-v1.1.1';
const APP_VERSION = '1.1.1';
const RELEASE_DATE = '2026-07-18';
const CACHE_PROTOCOL = 4;
const RELEASE_NOTES = [
  'Поле больше не меняет размер при открытии предпросмотра хода.',
  'Масштабирование, вращение и бегущий пунктир внутри SVG заменены неподвижной подсветкой.',
  'Ходы игрока и ИИ сохраняют фиксированную геометрию доски в обеих ориентациях.',
  'Добавлен контрактный тест стабильности анимаций.'
];
const APP_SHELL = [
  './',
  './index.html',
