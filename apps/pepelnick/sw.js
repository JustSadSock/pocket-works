...
const SHELL=['./','./index.html','./manifest.webmanifest','./icons/icon.svg','./styles.css','./state.js','./combat.js','./simulation.js','./render.js','./app.js','../../shared/mobile-runtime.css','../../shared/update-manager.css','../../shared/update-manager.js'];
