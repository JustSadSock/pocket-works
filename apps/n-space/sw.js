const CACHE_PREFIX = 'n-space-';
const CACHE_NAME = 'n-space-v1.0.0';
const APP_VERSION = '1.0.0';
const RELEASE_DATE = '2026-09-26';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Добавлены гиперкубы, симплексы и кросс-политопы от 1D до 5D.',
  'Добавлены вращения по произвольным плоскостям и перспективные/ортографические проекции в 4D, 3D, 2D и 1D.',
  'Добавлены касание вершин, координатный инспектор, цепочка проекций и сохранение состояния.'
];
const APP_SHELL = [
  './',
  './index.html',
