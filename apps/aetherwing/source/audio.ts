...
export class FlightAudio{
  private ctx?:AudioContext; private master?:GainNode; private wind?:GainNode; private windFilter?:BiquadFilterNode; private rumble?:GainNode; private wingPhase=0; private started=false;
  async start(){
    ...
    const master=ctx.createGain();master.gain.value=.7;master.connect(ctx.destination);this.master=master;
