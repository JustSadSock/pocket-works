...
const CACHE_NAME = 'khrebet-v1.0.0-p1';
const APP_VERSION = '1.0.0';
const RELEASE_DATE = '2026-07-15';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Добавлен бесконечный процедурный 3D-разлом с меняющимся светом, туманом и скальными препятствиями.',
  'Реализованы прямое управление вингсьютом, пикирование, серии, воздушный поток и маршрут дня.',
  'Добавлены сохранение полёта, звук, вибрация, обучение, рекорды, Workshop Mode и автономная загрузка.'
];
const APP_SHELL = [
  './',
  './index.html',
