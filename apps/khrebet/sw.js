...
const CACHE_NAME = 'khrebet-v1.1.0-p2';
const APP_VERSION = '1.1.0';
const RELEASE_DATE = '2026-07-15';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Вингсьют заменён самолётом с пропеллером, огнями, форсажем и процедурным звуком двигателя.',
  'Исправлено зеркальное управление и сделаны честные сужающиеся коллизии скальных игл с рамкой близости.',
  'Добавлены четыре горных биома, новая атмосфера, растительность, вода, лёд и улучшенные визуальные эффекты.'
];
const APP_SHELL = [
  './',
  './index.html',
