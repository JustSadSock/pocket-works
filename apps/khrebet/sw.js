const CACHE_PREFIX = 'khrebet-';
const CACHE_NAME = 'khrebet-v1.2.2-p4';
const APP_VERSION = '1.2.2';
const RELEASE_DATE = '2026-07-16';
const CACHE_PROTOCOL = 4;
const RELEASE_NOTES = [
  'Лёгкое движение вниз вызывает пологую глиссаду, а не резкое пикирование.',
  'Прогрессивная вертикальная кривая оставляет точность малым жестам и силу набору высоты.',
  'Сопротивление раскрытого бумажного крыла быстрее гасит падение и возвращает самолётик в полёт.',
  'Глубокое пикирование остаётся отдельным режимом со складыванием крыльев.',
  'Восходящий поток хребта поддерживает безопасную глиссаду: самолётик больше не падает сразу после старта.',
  'Исправлено фактическое экранное направление горизонтального управления.',
  'Стартовая высота увеличена, сохраняя пикирование, набор скорости и сваливание.',
  'Плавающий стик стал компактнее, быстрее и нагляднее; ввод сглаживается без потери отклика.',
  'Стабилизация полёта гасит боковой снос после отпускания и при желании отключается в настройках.',
  'Камера меньше заваливается, а прицел показывает направление текущей команды.',
  'Моторный самолёт заменён бумажным планером со складывающимися крыльями и визуальной деформацией.',
  'Добавлена аэродинамика с подъёмной силой, сопротивлением, обменом высоты на скорость и сваливанием.',
  'Маршруты получили арки, полки, валуны, растяжки и зональные повреждения с разным влиянием на управление.'
];
const APP_SHELL = [
  './',
  './index.html',
