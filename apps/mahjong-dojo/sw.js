...
const RELEASE_NOTES = [
  ...
  'Бесконечная лаборатория с расчётом сянтэна и укеирэ.',
  'Тренировочный стол против трёх ботов с тремя уровнями сложности.'
];
const APP_SHELL = [
  './','./index.html','./app.config.json','./styles.css','./app.js','./mahjong-core.js','./manifest.webmanifest','./icons/icon.svg',
