const CACHE_PREFIX = 'emergence-lab-';
const CACHE_NAME = 'emergence-lab-v1.1.0';
const APP_VERSION = '1.1.0';
const RELEASE_DATE = '2026-07-25';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Полностью переведён интерфейс приложения на русский язык.',
  'Добавлены ресурсы, энергетический обмен и стоимость движения.',
  'Добавлены наследуемые признаки, естественный отбор и визуализации энергии и поколений.'
];
const APP_SHELL = [
  ...
  '../../shared/capabilities/storage.js','../../shared/capabilities/transfer.js','../../shared/capabilities/diagnostics.js'
];
...
async function precacheFreshShell(){ const cache=await caches.open(CACHE_NAME);await Promise.all([...new Set(SHELL_KEYS.values())].map(async canonicalUrl=>cache.put(canonicalUrl,await fetchFresh(canonicalUrl)))); }
