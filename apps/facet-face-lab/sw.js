...
const CACHE_NAME = 'facet-face-lab-v1.2.0';
const APP_VERSION = '1.2.0';
const RELEASE_DATE = '2026-07-24';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Один кадр достаточен; ещё два кадра необязательны для проверки повторяемости.',
  'Исправлен зум камеры, добавлена проверка перекрытий и подробный анализ.'
];
const APP_SHELL = [
  ...
  '../../shared/workshop-mode.css', '../../shared/workshop-mode.js', '../../shared/capabilities/storage.js'
];
