...
const CACHE_NAME = 'sgib-v1.1.3';
const APP_VERSION = '1.1.3';
const RELEASE_DATE = '2026-07-14';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Жест использует замороженную систему координат и не реагирует на скачок visualViewport.',
  'Короткий тап и дрожание пальца больше не подтверждают сгиб.',
  'Предпросмотр зависит от реального движения в CSS-пикселях.',
  'Ошибка отдельного кадра больше не останавливает цикл рендера.'
];
const APP_SHELL = [
  './',
  './index.html',
