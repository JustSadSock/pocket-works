...
const CACHE_NAME = 'sgib-v1.1.2';
const APP_VERSION = '1.1.2';
const RELEASE_DATE = '2026-07-14';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Исправлена гонка Pointer Events в Safari при отпускании пальца после сгиба.',
  'Жест сохраняется до завершения pointerup и больше не стирается событием lostpointercapture.',
  'Добавлен оконный fallback для завершения жеста на iPhone.',
  'Предпросмотр оставляет финальное закрытие листа анимации после отпускания.'
];
const APP_SHELL = [
  './',
  './index.html',
