...
const CACHE_NAME = 'sgib-v1.1.1';
const APP_VERSION = '1.1.1';
const RELEASE_DATE = '2026-07-14';
const CACHE_PROTOCOL = 2;
const RELEASE_NOTES = [
  'Исправлен краш после сгиба: все runtime-фрагменты теперь загружаются только из одной версии сборки.',
  'Предпросмотр снова складывает бумагу постепенно, следуя длине жеста.',
  'Старые аудиофрагменты получили безопасную совместимость с новой механикой чернил.',
  'Ошибочный сгиб автоматически откатывается, не останавливая приложение.'
];
const APP_SHELL = [
  './',
  './index.html',
