...
const RELEASE_NOTES = [
  ...
  "Каждое чтение выполняется в чистом WASM-экземпляре, а worker уничтожается после хода, поэтому память не накапливается между ходами.",
  "Сборка проходит строгий поведенческий аудит с тактическими позициями, дебютами и шестью наблюдаемыми партиями."
];
const APP_SHELL = [
  './',
  './index.html',
