...
const RELEASE_NOTES = [
  'Добавлена непрерывная популяционная симуляция с наследованием, мутациями, пищевыми цепями и видообразованием.',
  'Добавлены прямые инструменты среды, экологические события, геномный инспектор и журнал эволюции.',
  'Добавлены сохранение эксперимента, откат эпох, адаптивный мобильный интерфейс и полноценная офлайн-работа.'
];
