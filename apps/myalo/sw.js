...
const CACHE_NAME = 'myalo-v1.4.0';
const APP_VERSION = '1.4.0';
const RELEASE_DATE = '2026-07-13';
const RELEASE_NOTES = [
  'Убраны отдельные вырезанные фрагменты и фальшивые объёмные трубки.',
  'Нос, губы, глаза, уши и брови теперь вытягиваются непрерывной текстурной лентой от точки крепления.',
  'Мягкие части лица используют широкую локальную деформацию ткани с более сдержанным светом и тенью.'
];
