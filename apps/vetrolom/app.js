...
const patchNames=['patch-1.2.txt','patch-1.3-a.txt','patch-1.3-b.txt','patch-1.3-c.txt'];
const root='./runtime/';
const manager=document.querySelector('script[data-update-manager]');
if(manager)manager.dataset.appVersion='1.3.0';
if(!document.querySelector('link[href="./polish-1.3.css"]')){
  const style=document.createElement('link');
  style.rel='stylesheet';
  style.href='./polish-1.3.css';
