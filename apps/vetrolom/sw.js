...
const APP_SHELL = [
  ...
  './runtime/part-04.txt',
  './runtime/part-05.txt',
  './runtime/patch-1.2.txt',
  './runtime/patch-1.3-a.txt',
  './runtime/patch-1.3-b.txt',
  './runtime/patch-1.3-c.txt',
  './runtime/patch-1.4-a.txt',
  './runtime/patch-1.4-b.txt',
  './runtime/patch-1.4-c.txt',
  './runtime/patch-1.5-a.txt',
  './runtime/patch-1.5-b.txt',
  './runtime/patch-1.5-c.txt',
