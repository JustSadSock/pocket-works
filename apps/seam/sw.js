...
const RELEASE_NOTES=['Fixed the board module syntax error that prevented the entire application from starting.','Menu, rules and start buttons now bind after a successful module import.','The board module now uses a new URL and offline cache so the broken copy cannot be reused.'];
