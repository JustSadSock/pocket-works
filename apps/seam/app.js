...
import { BoardView } from './board-view.js?v=2.2.0-visual.1';
const VERSION='2.2.0';
const visual=document.createElement('link');visual.rel='stylesheet';visual.href='./visual.css?v=2.2.0-visual.1';document.head.append(visual);
