...
const RELEASE_NOTES = [
  'Первый выпуск генератора рисовательных задач для бумаги, механического карандаша и лайнера.',
  'Добавлены этапы практики, саморазбор, локальные фотографии и карта навыков.'
];
const APP_SHELL = [
  './',
  './index.html',
