...
type AetherwingState={
  loadingState?:string;started?:boolean;dragonReady?:boolean;usedFallback?:boolean;animationGroups?:number;boneCount?:number;chunks?:number;fauna?:number;terrainMeshes?:number;waterMeshes?:number;riverMeshes?:number;materialsHealthy?:boolean;vegetationInstances?:number;treeInstances?:number;groundHeight?:number;brakeEvents?:number;lastGesture?:string;mode?:string;speed?:number;altitude?:number;pitch?:number;roll?:number;quality?:number;assetErrors?:string[];
};
